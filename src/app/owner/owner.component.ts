...
export class OwnerComponent implements OnInit {
  ...
  changeFirstname(): void {
    if (this.newFirstname == "") {
      ...
      this.userService.changeFirstname(this.owner.id, this.newFirstname).subscribe(() => this.ngOnInit());
    }
  }
  ...
  changeLastname(): void {
    if (this.newLastname == "") {
      ...
      this.userService.changeLastname(this.owner.id, this.newLastname).subscribe(() => this.ngOnInit());
    }
  }
  ...
  changeAddress(): void {
    if (this.newAddress == "") {
      ...
      this.userService.changeAddress(this.owner.id, this.newAddress).subscribe(() => this.ngOnInit());
    }
  }
  ...
  changeContact(): void {
    if (this.newContact == "") {
      ...
      this.userService.changeContact(this.owner.id, this.newContact).subscribe(() => this.ngOnInit());
    }
  }
  ...
  changeCreditCard(): void {
    if (this.newCreditCard == "") {
      ...
      this.userService.changeCreditCard(this.owner.id, this.newCreditCard).subscribe(() => this.ngOnInit());
    }
  }
  ...
  changeProfilePicture(): void {
    if (this.errorImageFormat) {
      ...
      this.errorMessage = "";
      this.userService.changeProfilePicture(this.owner.id, this.newProfilePicture).subscribe(
        () => this.ngOnInit()
      );
    }
  }
